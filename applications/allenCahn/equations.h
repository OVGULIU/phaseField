...
template <int dim>
void generalizedProblem<dim>::residualRHS(const dealii::AlignedVector<modelVariable<dim> > & modelVariablesList,
...
template <int dim>
void generalizedProblem<dim>::residualLHS(const dealii::AlignedVector<modelVariable<dim> > & modelVarList,
...
template <int dim>
void generalizedProblem<dim>::energyDensity(const dealii::AlignedVector<modelVariable<dim> > & modelVarList,
